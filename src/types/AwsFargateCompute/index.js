...
const AwsFargateCompute = async (SuperClass, superContext) => {
  const AwsEcsService = await superContext.loadType('AwsEcsService')
  return {
    async defineFunction(functionInstance, context) {
      ...
      return context.construct(AwsEcsService, inputs)
    },
...
export default AwsFargateCompute
